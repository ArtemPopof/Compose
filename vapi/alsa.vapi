...
namespace AlsaNew {
    ...
    [Compact]
    [CCode (cname = "snd_pcm_sw_params_t", cprefix = "snd_pcm_sw_params_", free_function = "snd_pcm_sw_params_free")]
    public class PcmSoftwareParams
    {
        public static int malloc( out PcmSoftwareParams params );
    }
    ...
    public class PcmDevice
    {
        ...
        public int sw_params_current( PcmSoftwareParams params );
        ...
        public int sw_params_set_avail_min( PcmSoftwareParams params, int frames );
        public int sw_params_set_start_threshold( PcmSoftwareParams params, PcmUnsignedFrames frames );
        // format conversion
